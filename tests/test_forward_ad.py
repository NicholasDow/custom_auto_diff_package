...
# Since it's hard to identify lambda functions by trace I used increasing numbers
# What I plant to do in the future is "eval" a string that represents a function
# will do later my bad
...
# making list of labda functions doesn't work so I'm declaring them here
a1 = lambda x,y: x + y
b2 = lambda x,y: y * x
